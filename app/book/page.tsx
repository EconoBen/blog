    ...
    <EditorialPageFrame currentPath="/book">
      <main className="mx-auto max-w-[1440px] px-8">
        ...
        <header className="grid grid-cols-1 items-start gap-8 py-12 md:grid-cols-12 md:items-center md:gap-12 md:py-16">
          ...
          {/* Desktop cover */}
          <div className="relative order-2 hidden md:col-span-5 md:order-none md:block">
        ...
        <section className="md:hidden">
          <div className="mx-auto mt-2 flex max-w-[16rem] items-center justify-center overflow-hidden rounded-2xl border border-outline-variant/15 bg-surface-container-low p-3 shadow-[0_18px_50px_rgba(29,28,22,0.04)]">
