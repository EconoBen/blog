...
const ToolSnippetPreview = dynamic(() => import('../components/ToolSnippetPreview'), {
  loading: () => <p className="font-body text-sm text-secondary" role="status">Loading preview…</p>,
});
