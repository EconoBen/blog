...
- [x] Create PR: `gh pr create --title "fix: comprehensive mobile polish pass" --body "Mobile audit findings from 390px Playwright screenshots. Tightened spacing, removed redundant elements, improved density across all pages. Desktop unchanged."`
