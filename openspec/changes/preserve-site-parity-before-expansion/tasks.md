...
Stacked review follow-up note (March 24, 2026, pass 3): the `/code-ai` slice was refined again, merged into `feat/site-current-review`, rebuilt in production mode, and rechecked at `http://127.0.0.1:3018` with screenshots under `.playwright-discovery/stacked-review-20260324-codeai-pass3/`.
- `/code-ai` is calmer than the previous pass. The first real code entry still appears in the opening viewport at `539px` on desktop and `596px` on mobile, with `0px` horizontal overflow, while the filter block now reads as a compact archive tool instead of a dashboard panel.
- The route remains open only for final editorial polish; it is no longer failing on content order or control weight.

Stacked review follow-up note (March 24, 2026, pass 3b): the refreshed `/posts` slice was also restacked onto `feat/site-current-review`, rebuilt in production mode, and rechecked at `http://127.0.0.1:3018` with screenshots under `.playwright-discovery/stacked-review-20260324-posts-codeai-pass3/`.
- `/posts` now gives the latest year real editorial weight instead of treating every year block the same. The first real post module still lands at `475px` on desktop and `645px` on mobile, with `0px` horizontal overflow, while the remaining years now read as secondary browse cards instead of co-equal ledgers.
- The route remains open, but the blocker is narrower now: final editorial browse polish and topic-section rhythm, not another structural rescue.

Stacked review follow-up note (March 24, 2026, pass 4): the `/posts` opening section was refined again, merged into `feat/site-current-review`, rebuilt in production mode, and rechecked at `http://127.0.0.1:3018` with screenshots under `.playwright-discovery/stacked-review-20260324-posts-pass4/`.
- `/posts` no longer wastes the full width on a single under-filled latest-post slab. The opening section now uses a narrower featured post plus supporting recent/topic entry routes, while keeping the first real post module at `475px` on desktop and `645px` on mobile with `0px` horizontal overflow.
- The route remains open for final polish, but the opening composition is now materially stronger than the earlier human-review screenshot.
...
| `/posts` | `.playwright-discovery/tab-audit-20260323-wave5-recheck/posts-desktop.png`, `.playwright-discovery/tab-audit-20260323-wave5-recheck/posts-mobile.png`, `.playwright-discovery/stacked-review-20260324-posts-codeai/posts-desktop-full.png`, `.playwright-discovery/stacked-review-20260324-posts-codeai-pass2/posts-desktop-full.png`, `.playwright-discovery/stacked-review-20260324-posts-codeai-pass2/posts-mobile-full.png`, `.playwright-discovery/stacked-review-20260324-posts-codeai-pass3/posts-desktop-full.png`, `.playwright-discovery/stacked-review-20260324-posts-codeai-pass3/posts-mobile-full.png`, `.playwright-discovery/stacked-review-20260324-posts-pass4/posts-desktop.png`, `.playwright-discovery/stacked-review-20260324-posts-pass4/posts-mobile.png` | Improved, but still open. The stacked pass-4 review keeps the first real post module in the opening viewport (`475px` desktop, `645px` mobile, `0px` overflow) and fixes the oversized opening slab by turning it into a real browse section with supporting recent/topic routes. Remaining work is final browse polish: stronger rhythm in the year/topic sections and less residual card-ledger sameness. | `blog-mkj` / `#57`, `blog-mkj.2` / `#69` |
...
| `/code-ai` | `.playwright-discovery/tab-audit-20260323-wave6-final/code-ai-desktop-fold1.png`, `.playwright-discovery/tab-audit-20260323-wave6-final/code-ai-mobile-fold1.png`, `.playwright-discovery/stacked-review-20260324-posts-codeai/code-ai-desktop-full.png`, `.playwright-discovery/stacked-review-20260324-posts-codeai-pass2/code-ai-desktop-full.png`, `.playwright-discovery/stacked-review-20260324-posts-codeai-pass2/code-ai-mobile-full.png`, `.playwright-discovery/stacked-review-20260324-codeai-pass3/code-ai-desktop.png`, `.playwright-discovery/stacked-review-20260324-codeai-pass3/code-ai-mobile.png` | Improved, but still open. The stacked pass-3 review on the integrated preview kept the first real code entry in the opening viewport (`539px` desktop, `596px` mobile, `0px` overflow) and compressed the filter block so it reads more editorial and less dashboard-like. Remaining work is final polish on hierarchy and scan rhythm. | `blog-t75` / `#60`, `blog-vt2` / `#62`, `blog-vt2.1` / `#66` |
