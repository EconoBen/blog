...
| `/posts` | `.playwright-discovery/tab-audit-20260323-wave5-recheck/posts-desktop.png`, `.playwright-discovery/tab-audit-20260323-wave5-recheck/posts-mobile.png` | Not ready. Direct user review says the route still needs a lot of work. The current page is calmer than earlier waves, but it still reads as a thin yearly ledger with too little editorial depth and too much archive-explainer filler. | `blog-mkj` / `#57`, `blog-mkj.2` / `#69` |
...
| `/code-ai` | `.playwright-discovery/tab-audit-20260323-wave6-final/code-ai-desktop-fold1.png`, `.playwright-discovery/tab-audit-20260323-wave6-final/code-ai-mobile-fold1.png` | Not ready. Direct user review still finds the route rough and amateurish. Earlier calm-down passes helped, but the page still feels too control-led and under-composed compared with the strongest editorial tabs. | `blog-t75` / `#60`, `blog-vt2` / `#62`, `blog-vt2.1` / `#66` |
