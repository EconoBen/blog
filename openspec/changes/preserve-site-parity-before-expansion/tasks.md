...
- [ ] 13.6 Capture a follow-up stacked review for `/posts` and `/code-ai` specifically, and do not downgrade either route until the first post/code entry appears in the opening viewport without the current amount of dead hero space
...
| `/posts` | `.playwright-discovery/tab-audit-20260323-wave5-recheck/posts-desktop.png`, `.playwright-discovery/tab-audit-20260323-wave5-recheck/posts-mobile.png`, `.playwright-discovery/stacked-review-20260324-posts-codeai/posts-desktop-full.png` | Not ready. The stacked review shows the first real post module still starts too low on desktop after a full viewport of title copy, chips, stats, and a second oversized intro block. The next pass must bring content up, not add more route explanation. | `blog-mkj` / `#57`, `blog-mkj.2` / `#69` |
...
| `/code-ai` | `.playwright-discovery/tab-audit-20260323-wave6-final/code-ai-desktop-fold1.png`, `.playwright-discovery/tab-audit-20260323-wave6-final/code-ai-mobile-fold1.png`, `.playwright-discovery/stacked-review-20260324-posts-codeai/code-ai-desktop-full.png` | Not ready. The stacked review shows the first real code entry still starts too low on desktop because hero copy, browse framing, category chips, and mode controls consume the page entry. The next pass must bring actual entries up and compress control chrome sharply. | `blog-t75` / `#60`, `blog-vt2` / `#62`, `blog-vt2.1` / `#66` |
