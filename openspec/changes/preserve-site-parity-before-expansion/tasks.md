...
| `/posts` | `.playwright-current-review-20260330-posts-pass3/posts-desktop.png`, `.playwright-current-review-20260330-posts-pass3/posts-mobile.png` | Improved but still open. The page now opens with actual browse value and the year archive reads more like a ledger than a stack of oversized promo cards. It remains the weakest route in the current-review stack because the composition still needs more editorial confidence and differentiation from `/archive`, but the old dead-space failure is resolved. | `blog-mkj` / `#57`, `blog-mkj.2` / `#69` |
