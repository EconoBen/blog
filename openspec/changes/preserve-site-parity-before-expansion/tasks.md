...
| `/posts` | `.playwright-discovery/tab-audit-20260323-wave5-recheck/posts-desktop.png`, `.playwright-discovery/tab-audit-20260323-wave5-recheck/posts-mobile.png`, `.playwright-discovery/stacked-review-20260324-posts-codeai/posts-desktop-full.png`, `.playwright-discovery/stacked-review-20260324-posts-codeai-pass2/posts-desktop-full.png`, `.playwright-discovery/stacked-review-20260324-posts-codeai-pass2/posts-mobile-full.png`, `.playwright-discovery/stacked-review-20260324-posts-codeai-pass3/posts-desktop-full.png`, `.playwright-discovery/stacked-review-20260324-posts-codeai-pass3/posts-mobile-full.png` | Improved, but still open. The stacked pass-3 review keeps the first real post module in the opening viewport (`475px` desktop, `645px` mobile, `0px` overflow) and gives the latest year real editorial weight instead of a flat same-weight year grid. Remaining work is final browse polish: stronger rhythm in the year/topic sections and less residual card-ledger sameness. | `blog-mkj` / `#57`, `blog-mkj.2` / `#69` |
