...
- **Pages Analyzed**: 7
- **HTML Files Captured**: 7
- **CSS Files Downloaded**: 1

## CSS Analysis

- **Total CSS Files**: 1
- **Total CSS Size**: 92.92 KB
- **Total Selectors**: 1182
- **Unique Selectors**: 769
- **CSS Properties Used**: 175
- **Media Queries**: 25
- **CSS Custom Properties**: 59
- **Detected Frameworks**: Foundation
